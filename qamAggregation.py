...
def randomTest():
   for ranges in range(5,256,10):
      ...
      print "average for", ranges,"random:\t\t", ave1, ave2, "{0:.4f}".format(ave1/(ranges*times*1.0)), " {0:.4f}".format(ave2/(ranges*times*1.0)), "\t\t in", end-start, "seconds"
...
def randomTestContElem( endPoint, step, elemNum ):
   for ranges in range(1, endPoint, step):
      ...
      for iter in range(times):
         ...
         ave1 += ret1
         ave2 += ret2
      print "average for", ranges,"random ", elemNum," elem:\t\t", ave1, ave2, "{0:.4f}".format(ave1/(ranges*10.0*times)), " {0:.4f}".format(ave2/(ranges*10.0*times))
